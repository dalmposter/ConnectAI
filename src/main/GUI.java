...
public class GUI extends javax.swing.JFrame
{
    ...
    public <T extends Component> T getComponentByName(String name)
    {
        for(Field field : this.getClass().getDeclaredFields())
        {
            ...
            {
                ConnectAI.log(Level.INFO, "ERROR in getComponentByName(" + name + ") : " + ex);
            }
        }
    ...
    public void buttonClick(int column)
    {
        ...
        if(controller.getPlayer())
        {
            ...
            if(controller.getBoard().makePlay(column, Integer.valueOf(controller.getPlayer1().getPiece())))
            {
                ...
                success = true;
                //ConnectAI.log(Level.INFO, "Play successful");
                ...
                switch (win) {
                    ...
                    case 1:
                        ...
                        controller.reset();
                        //ConnectAI.log(Level.INFO, "reset() called from win == 1");
                        break;
                    //p2 wins
                    case 2:
                        ...
                        controller.reset();
                        //ConnectAI.log(Level.INFO, "reset() called from win == 2");
                        break;
                    //draw
                    case 0:
                        ...
                        controller.reset();
                        //ConnectAI.log(Level.INFO, "reset() called from win == 0");
                        break;
                    //the game goes on
                    default:
                        break;
            ...
            else
            {
                ...
                ConnectAI.log(Level.SEVERE, " making play " + column + " unsuccessful for some reason");
            }
        }
        else
        {
        ...
        if(success)
        {
            //get the board ready for next move
            prepMove();
        }
    }
    
    //setters for the name to be displayed on gui
    ...
    //change everything so the game is ready for the next player to make their move
    private void prepMove()
    {
        controller.switchPlayer();

        //ConnectAI.log(Level.INFO, "player1? : " + ConnectAI.getPlayer() +  ", player1ai? : " + ConnectAI.getPlayer1().ai + ", player2ai? : " + ConnectAI.getPlayer2().ai);

        if(controller.getPlayer() && controller.getPlayer1().ai && !controller.getPlayer2().ai)
        {
            //ConnectAI.log(Level.INFO, "Sent player 1 to takeTurn()");
        ...
        {
            //ConnectAI.log(Level.INFO, "Sent player 2 to takeTurn()");
